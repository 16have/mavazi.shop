...
The project is built using HTML and CSS, making it lightweight and easy to customize for beginners learning web development.
...
mavazi-online-shopping/ │ ├── index.html # Homepage ├── about.html # About the shop ├── services.html # Services offered ├── contact.html # Contact page ├── products.html # Product listings │ ├── css/ │ └── styles.css # Main stylesheet │ ├── images/ │ └── (product images) │ └── README.md
...
Contact the business through the contact page
